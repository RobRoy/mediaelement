This is my fork of the fantastic MediaElement.js from [John Dyer](https://github.com/johndyer). It's basically a place for me to play around with HTML5's `<video>` and `<audio>` integration.
